...
namespace Logger.Models.Appenders
{
    public class FileAppender : IAppender
    {
        ...
        {
            return $"Appender type: {this.File.GetType().Name}, Layout type: {this.Layout.GetType().Name}, Report level: {this.Level.ToString().ToUpper()}, Messages appended: {this.MessagesAppended}, File size {this.File.Size}";
        }
    }
}
